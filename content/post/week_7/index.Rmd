...
For the first time since early August, FiveThirtyEight's predicted winner for the 2024 presidential election has changed. After nearly three months of a slight lead for the Harris campaign in the site's simulation counters, this weekend's simulations pointed to a slightly higher likelihood for the Trump campaign, with the Republican nominee winning 52 times out of 100.
...
![Rust Belt Polling vs. Vote Share](imgs/rustbelt.png)
...
![Pennsylvania Voters](imgs/penn_voters.png)
...
![Simulations](imgs/penn_simulations.png)

I repeated this process for each of the other six swing states:

![Michigan](imgs/michigan_simulations.png) 
Michigan
![Wisconsin](imgs/wisconsin_simulations.png) 
Wisconsin
![Nevada](imgs/nevada_simulations.png) 
Nevada
![Arizona](imgs/arizona_simulations.png) 
Arizona
![Georgia](imgs/georgia_simulations.png) 
Georgia
![North Carolina](imgs/nc_simulations.png) 
North Carolina
...
![538](imgs/harris_pollav_538.png)
